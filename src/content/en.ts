  ...
  play: {
    ...
    help: {
      ...
      items: [
        ...
        'Each Die modifiers apply the configured operation to every modifier-active numeric or countable symbol-number result. Each die can cycle between modifier-active, normal, and locked.',
